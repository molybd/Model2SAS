...
from utility_new import timer, convert_coord, abi2modarg, modarg2abi
...
class Model:
    ...
    def get_F_value(self, reciprocal_coord: Tensor) -> Tensor:
        ...
        To be overwritten.
        '''
        F_value = torch.ones(reciprocal_coord.shape[0], dtype=torch.complex)
        return F_value
...
if __name__ == '__main__':
    ...
    from plot_new import plot_parts, plot_sas1d
