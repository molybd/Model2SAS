...
class specific_mathmodel:
    ...
    def __init__(self):
        ...
        self.boundary_min = np.array([-100, -100, -100])
        self.boundary_max = np.array([100, 100, 100])
        self.coord = 'xyz'  # 'xyz' or 'sph' or 'cyl'
    ...
    def sld(self):
        pass
        return 1 * self.in_model_grid_index
        # return the sld of each point