...
from PySide6.QtWidgets import QApplication, QMainWindow, QWidget, QFileDialog, QInputDialog
...
class MainWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        self.qmodel_for_treeview = QStandardItemModel(self)
    ...
    def load_model_files(self):
        ...
        # assmb.add_part(
        #     self.model2sas_models.pop('torus'),
        #     self.model2sas_models.pop('cylinder'),
        # )
        # self.model2sas_models['assmb_0'] = assmb
    ...
    def selected_model_settings(self):
        if self.ui.treeView_models.selectedIndexes()[0].parent().row() == -1:
            ...
            self.ui.pushButton_sampling.setDisabled(True)
            self.ui.pushButton_plot_model.setDisabled(False)
            self.ui.pushButton_scattering.setDisabled(True)
    ...
    def sampling(self):
        ...
        self.active_model.model.sampling(real_lattice_1d_size=real_lattice_1d_size)
        self.plot_model()
